"""
References:
- https://github.com/yandex-research/tabular-dl-num-embeddings/blob/main/lib/data.py
- https://github.com/yandex-research/tabular-dl-num-embeddings/blob/main/lib/util.py
"""
import json
import enum
import pickle
